...
See [CLAUDE.md](CLAUDE.md) for full architecture, database schema, API routes, and development conventions. See [HANDOFF.md](HANDOFF.md) for current state, recent work, and the next action.
