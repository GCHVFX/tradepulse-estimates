...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${CANONICAL_URL}/electrical-cost` },
  openGraph: {
    title: "How Much Does an Electrician Cost in 2026? Real Pricing Guide",
    description: "Real electrical costs for common jobs in Canada. Panel upgrades, outlet installs, EV chargers, and more. Prices include labour and materials.",
    ...
    <div className="min-h-dvh bg-white flex flex-col font-[family-name:var(--font-dm-sans)]">
      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-16 pb-36">
        <div className="w-full max-w-lg">
          ...
          <div className="mt-12">
            <h2 className="text-xl font-bold text-[#26211B]">Sample estimate: Panel upgrade</h2>
            <p className="mt-2 text-sm text-[#5C4A2E]">This is what a professional electrical estimate looks like for a 200A panel upgrade.</p>
            ...
            <div className="mt-4 rounded-2xl bg-white border border-[#C9B384] shadow-sm p-5">
              ...
              <h3 className="mt-2 text-lg font-bold text-[#26211B]">200A Electrical Panel Upgrade</h3>
