...
// Sanitised representatives of the real production corpus, captured 2026-07-31.
// Kept in a separate module so an edit to the captured corpus can never
// silently disturb the synthetic one above.
//
